...
$(document).ready(function(){
        ...
        if (typeof (Storage) !== "undefined") {
            ...
            if (!sessionStorage.getItem('spalashShown') || sessionStorage.getItem('spalashShown') === null) {
                ...
                setTimeout(function () {
                    ...
                    //window.location = "http://shairayvonnecruz028.000webhostapp.com/index.php/main/home_page/shairacruz#";
    ...
    $("#Login").click(function () {
        ...
        if ($.trim(Username).length > 0 & $.trim(Password).length > 0) {
            $.ajax({
                type: "POST",
                url: "http://shairayvonnecruz028.000webhostapp.com/index.php/main/login",
                data: 
                {
                    "Username":Username, 
                    "Password":Password
   ...
   function showLogResult(result) {
    ...
    var onSuccess = function(position) {
        ...
        */
        // ROdriguez 14.732060, 121.145338
        // PAsig 14.607546599999997, 121.1080133
        // RCBC ATM 14.608759, 121.103647
        // Sta. Lucia 14.618420, 121.100958
        //Dyan lang 14.616118, 121.101457
